...
entity rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
...
entity rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    generic (
...
architecture arch of rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    component rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom_U :  component rand_top_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
